export function HowItWorksC4() {
  const steps = [
    {
      number: '1',
      title: 'Free design consult',
      description: 'Share your brief, preferences, and budget, whether it\'s for a modular kitchen, a 2BHK, a 3BHK, or a full home. We\'ll walk you through our process and guarantees.',
    },
    {
      number: '2',
    ...
    },
    {
      ...
      description: 'In-house manufacturing, LiDAR-precision installation. Handover within 45 days* from design confirmation. Your 15-year warranty begins with free replacement for the first 5 years (no T&C). Two-year AMC included.',
    },
  ]
    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-center text-base max-w-2xl mx-auto mb-12" style={{ color: '#717171' }}>
          Whether it&apos;s a modular kitchen, a 2BHK apartment, or a 3BHK home in Chennai, every project follows the same documented process.
        </p>
